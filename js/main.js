...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.special__swiper', {
  slidesPerView: "auto",
  loop: false,
  spaceBetween: 32,
  navigation: {
    nextEl: '.special__btn-arrows-right',
    prevEl: '.special__btn-arrows-left'
  },
  breakpoints: {
    320: {
      slidesPerView: "auto",
...
const swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.useful__swiper', {
  slidesPerView: "auto",
  loop: false,
  spaceBetween: 32,
  navigation: {
    nextEl: '.useful__btn-arrows-right',
    prevEl: '.useful__btn-arrows-left'
  },
  breakpoints: {
    320: {
      slidesPerView: "auto",
...
const rules = [{
  ...
  rules: [{
    ...
    errorMessage: 'Недопустимый формат.Введите буквы'
  }, {
    rule: 'minLength',
    value: 2,
    errorMessage: 'Мин.размер имени 2 буквы'
  }]
}, {
  ruleSelector: '.input-chekbox',
  rules: [{
    rule: 'required',
    value: true,
